...
static size_t extra_len = 0;

static const char *random_extra;
static size_t random_extra_len = 0;
...
init (void)
{
  ...
  if (param.random_additional_header)
    random_extra = unescape(param.random_additional_header, &random_extra_len);
